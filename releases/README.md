...
> ℹ️ **Примечание:** зафиксированный в репозитории `VirtualMax.apk` — это последняя проверенная сборка (**v1.3.0**, подпись v1+v2+v3). Актуальные версии дополнительно публикуются в GitHub Releases при создании тега `v*`.
