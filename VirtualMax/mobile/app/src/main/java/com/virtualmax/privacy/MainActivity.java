    ...
    private void setupWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                view.evaluateJavascript(PrivacyInterceptor.INJECTED_SANDBOX_JS, null);
            }
    ...
    private void setupSettingsToggles() {
        ...
        switchGhost.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                Toast.makeText(MainActivity.this, isChecked ? "👻 Режим Невидимки: ВКЛЮЧЕН" : "Режим Невидимки: ВЫКЛЮЧЕН", Toast.LENGTH_SHORT).show();
            }
        });
